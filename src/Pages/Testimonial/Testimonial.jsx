    ...
    return (
        <div className="mt-20">
            <div className="text-center space-y-4 mb-10">
                <h2 className="text-xl text-red-500 font-bold">Testimonial</h2>
            ...
            <div class="mb-20 relative flex w-full flex-col md:flex-row gap-5 rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
